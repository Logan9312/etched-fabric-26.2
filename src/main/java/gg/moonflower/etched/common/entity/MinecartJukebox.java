...
public class MinecartJukebox extends AbstractMinecart implements WorldlyContainer {
    ...
    protected void addAdditionalSaveData(ValueOutput output) {
        ...
        output.putBoolean("HasRecord", this.entityData.get(DATA_ID_HAS_RECORD));
        if (!this.record.isEmpty()) {
            output.store("RecordItem", ItemStack.CODEC, this.record);
        }
    }
    ...
    protected void readAdditionalSaveData(ValueInput input) {
        ...
        this.entityData.set(DATA_ID_HAS_RECORD, input.getBooleanOr("HasRecord", false));
        this.record = input.read("RecordItem", ItemStack.CODEC).orElse(ItemStack.EMPTY);
    }
