...
public class MusicLabelDyeRecipe extends CustomRecipe {
    ...
    private static ItemStack applyDyes(ItemStack stack, Iterable<DyeColor> dyes) {
        ...
        stack.set(EtchedComponents.MUSIC_LABEL.get(), label.withColor(ARGB.color(0, (int) (avgRed * avgLuminosity / brightness), (int) (avgGreen * avgLuminosity / brightness), (int) (avgBlue * avgLuminosity / brightness))));
        return stack;
    }
